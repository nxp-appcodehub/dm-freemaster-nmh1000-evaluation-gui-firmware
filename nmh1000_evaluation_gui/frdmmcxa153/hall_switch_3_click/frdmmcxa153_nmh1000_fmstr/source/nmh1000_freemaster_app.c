...
/**
 * @file nmn1000_freemaster_app.c
 * @brief The nmn1000_freemaster_app.c file implements the component library example application for nmh1000 sensor
 *        using FreeMASTER Host IO.
 */
